import { ElementRef, EventEmitter, OnDestroy, OnChanges, SimpleChange, NgZone, TemplateRef } from '@angular/core';
...
export declare class DropDownListComponent implements ControlValueAccessor, OnDestroy, OnChanges {
    ...
    constructor(rtl: boolean, popupService: PopupService, selectionService: SelectionService, navigationService: NavigationService, _zone: NgZone);
    /**
     * @hidden
     */
    onFilterFocus(): void;
