...
/**
 * A type representing a function that compares 2 values and returns `1`, `0`, or `-1` (minus one).
 *
...
/**
 * Converts the `SortDescriptors` into a [`Comparer`]({% slug api_kendo-data-query_comparer_kendouiforangular %})
