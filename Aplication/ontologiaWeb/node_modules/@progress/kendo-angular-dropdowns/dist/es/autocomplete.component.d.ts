import { ElementRef, EventEmitter, TemplateRef, OnDestroy, SimpleChange, OnChanges } from '@angular/core';
...
export declare class AutoCompleteComponent implements ControlValueAccessor, OnDestroy, OnChanges {
    ...
    constructor(rtl: boolean, popupService: PopupService, selectionService: SelectionService, navigationService: NavigationService, wrapper: ElementRef);
    ngOnDestroy(): void;
