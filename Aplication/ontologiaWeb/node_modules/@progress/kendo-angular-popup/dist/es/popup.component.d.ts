import { AfterViewChecked, ChangeDetectorRef, ElementRef, EventEmitter, OnInit, OnDestroy, Renderer, TemplateRef } from '@angular/core';
...
export declare class PopupComponent implements AfterViewChecked, OnInit, OnDestroy {
    ...
    constructor(container: ElementRef, _alignService: AlignService, _domService: DOMService, _cdr: ChangeDetectorRef, _positionService: PositionService, _resizeService: ResizeService, _scrollableService: ScrollableService, _renderer: Renderer);
    ngOnInit(): void;
