...
/**
 * The result of the [aggregate operation]({% slug api_kendo-data-query_aggregateby_kendouiforangular %})
 * where the keys are the field name used for the calculation and the values
 * are an object with the aggregate function name and a resulting value.
 *
 * @example
 * ```js
